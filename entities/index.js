...
function setLevel(level) {
    ...
    if (level === `3`) {
        ...
        return {
            ...
            Zombie1: Zombie(world, { x: windowWidth / 2 - 20, y: windowHeight / 2 - 55 }, { width: 75, height: 70 }, '1'),
            ...
            Zombie4: Zombie(world, { x: windowWidth / 2 + 70, y: windowHeight / 2 - 55 }, { width: 75, height: 70 }, '4'),
        }
    }
